...
## Passo 1 — Criação da pasta e dos arquivos via terminal

```bash
$ cd "Anderson Playbook"
$ mkdir -p QA && touch QA/checklist-qa-v1.md QA/casos-de-teste-v1.md
$ ls -la QA/
total 0
drwxr-xr-x@  4 juniorcesar  staff  128 Aug 11 14:43 .
drwxr-xr-x@ 15 juniorcesar  staff  480 Aug 11 14:43 ..
-rw-r--r--@  1 juniorcesar  staff    0 Aug 11 14:43 casos-de-teste-v1.md
-rw-r--r--@  1 juniorcesar  staff    0 Aug 11 14:43 checklist-qa-v1.md
```

Pasta `QA/` e os dois arquivos criados via terminal com `mkdir -p` e
`touch`. Depois de preenchidos no Obsidian:

```bash
$ ls -la QA/
-rw-r--r--@  1 juniorcesar  staff  6014 Aug 11 14:43 casos-de-teste-v1.md
-rw-r--r--@  1 juniorcesar  staff  2263 Aug 11 14:43 checklist-qa-v1.md
```
